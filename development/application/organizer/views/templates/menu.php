									...
									<ul class="nav navbar-right">
										...
										<li class="dropdown">
												...
												<div class="tooltip-notification hide">
													...
													<div class="tooltip-notification-inner">
														<div>
															...
															<div class="message">
																Try the Quick Access Experience
															</div>
														</div>
													</div>
												</div>
											...
											<ul class="dropdown-menu dropdown-light dropdown-subview">
												...
												<li>
													<a href="event_create.html"><a href=""><span class="fa-stack"> <i class="fa fa-file-text-o fa-stack-1x fa-lg"></i> <i class="fa fa-plus fa-stack-1x stack-right-bottom text-danger"></i> </span> Add new Event</a></a>
												</li>
												<li>
													<a href="#readNote" class="read-all-notes"><span class="fa-stack"> <i class="fa fa-file-text-o fa-stack-1x fa-lg"></i> <i class="fa fa-share fa-stack-1x stack-right-bottom text-danger"></i> </span> List all Events</a>
												</li>
												<li class="dropdown-header">
													Calendar
												</li>
												<li>
													<a href="#newEvent" class="new-event"><span class="fa-stack"> <i class="fa fa-calendar-o fa-stack-1x fa-lg"></i> <i class="fa fa-plus fa-stack-1x stack-right-bottom text-danger"></i> </span> Add new Item</a>
												</li>
												<li>
